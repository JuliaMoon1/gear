...
fn cascading_messages_with_value_do_not_overcharge() {
    ...
    new_test_ext().execute_with(|| {
        ...
        // The condition commented out below must hold:
        // assert_eq!(BalancesPallet::<Test>::free_balance(USER_1), user_initial_balance - (gas_to_spend as u128 + value));
        // However, holds the other one:
        assert_eq!(
            BalancesPallet::<Test>::free_balance(USER_1),
